...
<div align="center">
  ...
  <h3><b>Welcome to To Leader Board Website </b></h3>
...
> Here you can add user with its score through the API.
...
```bash
git clone https://github.com/ghreza-crypto/Leaderboard.git
```
...
- **[adding user with its score through the api]**
- **[getting user list with score through the api]**
- **[working with out refreshing page]**
...
- [ ] **[Adding time section for specifying each user completed time]**
